...
{
    public class DropDownItemBindingParameters(
    ...
    ) : ItemBindingParameters(name, property, title, stringFormat, fieldTypeSource)
	{
        public DropDownTemplateParameters DropDownTemplate { get; } = dropDownTemplate;
        public bool RequiresReload { get; } = requiresReload;
    }
}
