...
{
    public class FormGroupBoxSettingsParameters : IFormItemSettingsParameters
	{
		...
		public List<IFormItemSettingsParameters> FieldSettings { get; }
		public MultiBindingParameters? HeaderBindings { get; }
